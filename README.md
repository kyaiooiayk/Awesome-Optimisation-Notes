...
- [CVXPY](https://www.cvxpy.org/) CVXPY is an open source Python-embedded modeling language for convex optimization problems. It lets you express your problem in a natural way that follows the math, rather than in the restrictive standard form required by solvers. **At the end of the day CVXPY is a wrapper that tries to make things easier.**
***